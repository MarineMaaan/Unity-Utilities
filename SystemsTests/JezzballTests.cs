...
namespace SystemsTests {
    public class JezzballTests {
        ...
        [Fact] public void PlayerController_LoseLife_DecrementsLives() { var player = new PlayerController(); Assert.Equal(3, player.Lives); player.LoseLife(); Assert.Equal(2, player.Lives); }
    }
}
